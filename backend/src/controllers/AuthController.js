...
exports.register = async(req,res)=>{
    ...
    let query ="INSERT INTO passenger( passenger_email, passenger_name, passenger_mobile_no, passenger_address, passenger_password, passenger_identification, passenger_post_code) VALUES (?,?,?,?,?,?,?)"
    database.query(query,[newPassenger.passenger_email,newPassenger.passenger_name,newPassenger.passenger_mobile_no,newPassenger.passenger_address,newPassenger.passenger_password,newPassenger.passenger_identification,newPassenger.passenger_post_code],(err,results)=>{
